...
//LPD8806 leds_[] = {
    //LPD8806( n_leds[0], data_pins_[0], clock_pins_[0] ),
    //LPD8806( n_leds[1], data_pins_[1], clock_pins_[1] )
//};

LPD8806 strip = LPD8806( 9, 22, 23 );

// Chase one dot down the full strip.
void colorChase(uint32_t c, uint8_t wait, unsigned strip_index = 0) 
{
    //LPD8806 strip = leds_[ strip_index ]i;
    int i;
...
void lightupLED( unsigned int buttonId )
{
